...
/// <summary>Feed List Item.</summary>
public class FeedListItem
{
	...
	/// <summary>Gets or sets the feed description.</summary>
	public string? Description { get; set; }

	/// <summary>Gets or sets the id.</summary>
	public int Id { get; set; }

	/// <summary>Gets or sets the image cache.</summary>
	...
	/// <summary>
	/// Gets or sets a value indicating whether the feed is favourite.
	/// </summary>
